    ...
    return (
        ...
        <ScrollView style={[styles.backgroundGray]}>
          ...
          <TouchableHighlight style={styles.btnSubmit} underlayColor='#ccc' onPress={this._submit.bind(this)}>
            <View>
              <Text style={styles.btnSubmitText} allowFontScaling={false}>重置密码</Text>
            </View>
          </TouchableHighlight>

          <View style={styles.tips}>
            <View style={styles.tipsl}>
              <Text style={[styles.tipsText]} allowFontScaling={false}>密码回忆到？<Text style={styles.tipsa} onPress={this._pressToLogin.bind(this)} allowFontScaling={false}>点此登录</Text></Text>
            </View>
          </View>
